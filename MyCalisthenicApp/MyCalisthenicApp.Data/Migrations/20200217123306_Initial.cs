    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramSubCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProgramSubCategories_ProgramCategories_ProgramCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProgramSubCategoryId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Exercises_ProgramSubCategories_ProgramSubCategoryId",
                        column: x => x.ProgramSubCategoryId,
                        principalTable: "ProgramSubCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Post_BlogCategories_CategoryId",
                        column: x => x.CategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisptachDate = table.Column<DateTime>(nullable: true),
                    TotalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Discount = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    DeliveryPrice = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercises_ProgramSubCategoryId",
                table: "Exercises",
                column: "ProgramSubCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgramSubCategories_ProgramCategoryId",
